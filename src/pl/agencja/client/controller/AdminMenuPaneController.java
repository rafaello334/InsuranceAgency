...
public class AdminMenuPaneController implements Initializable
{
	...
	@FXML
	private ToggleButton manageEmployeesToggleButton;
	...
	private void configureToggleGroup()
	{
		...
		manageEmployeesToggleButton.setToggleGroup(toggleGroup);
	...
	private void changeSceneToLogin(Stage prevStage)
	{
		try
		{
			...
			FXMLLoader loader = new FXMLLoader(
					getClass().getResource("/pl/agencja/client/view/start/LoginPane.fxml"));
	...
	private void configureButtons()
	{
		...
		manageEmployeesToggleButton.setOnAction(new EventHandler<ActionEvent>()
		{
			@Override
			public void handle(ActionEvent event)
			{
				try
				{
					if (manageEmployeesToggleButton.isSelected())
					{
						FXMLLoader loader = new FXMLLoader(
